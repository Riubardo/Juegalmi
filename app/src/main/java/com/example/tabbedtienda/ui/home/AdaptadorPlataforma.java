...
public class AdaptadorPlataforma extends RecyclerView.Adapter<AdaptadorPlataforma.ViewHolder> {
	...
	public AdaptadorPlataforma(Fragment fragmento, ArrayList<Plataforma> dataSet) {
		listaPlataformas = dataSet;
		this.fragment = fragmento;

		Log.e("", "Adaptador creado");
	}
	...
	public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
		viewHolder.getTvNombre().setText(listaPlataformas.get(position).getNombre() +":");
